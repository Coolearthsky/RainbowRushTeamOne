...
public class arm extends SubsystemBase {
  ...
  public void driveUpyDowny(double d) {
    upyDowny.drivePercentOutput(d);
  }
  public void getUpyDowny(){
    upyDowny.getSelectedSensorPosition();
  }
  public void driveLeftyRighty(double d) {
    leftyRighty.drivePercentOutput(d);
  }
